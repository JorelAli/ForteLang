...
//	  set.checkPurity(setDeclaration);
  ...
  final public FL_Function lambda() throws ParseException, Exception {
                                          Token paramName; Object innerExpression;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case VAR_NAME:
    ...
    default:
      ...
      throw new ParseException();
          ...
          {if (true) return new FL_Function(paramName.image, innerExpression);}
    throw new Error("Missing return statement in function");
  }
...
/** Expressions */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfe,0x8000,0x0,0x1000000,0xdffbf00,0x300,0x1000000,0x5ffbf00,0x5ffbf00,0x1000000,0x0,0xfe0000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x10,0x10,0x54,0x0,0x0,0x54,0x54,0x0,0x10,0x0,};
   }
